...
if __name__ == "__main__":
    ...
    leak_corrected = test_get_leak_correct(trace, currents, QC_filt, ramp_bounds = [1700, 2500])
    print('All tests passed')

    # test plotting leak fit
    test_plot_leak_fit(currents, QC_filt, well = 'D15', sweep = 9, ramp_bounds = [48300, 49100])